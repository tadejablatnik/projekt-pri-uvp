...
def vsota_prvih_kvadratov(n):
    if n == 0:
        ...
        return vsota_prvih_kvadratov(n-1) + n**2
# =====================================================================@000955=
# 3. podnaloga
...
def vsota_prvih_potenc(n, k=1):
    if n == 0:
        ...
        return vsota_prvih_potenc(n-1, k) + n**k 

    vsota_prvih_potenc(5, 3)
    vsota_prvih_potenc(5, 1)
    vsota_prvih_potenc(5)
