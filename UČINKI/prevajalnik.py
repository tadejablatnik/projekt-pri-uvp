...
# =====================================================================@009841=
# 1. podnaloga
# V tej nalogi nadgradimo slovar iz prejšnjih vaj v program, s katerim
# lahko prevajamo stavke. V datoteki `prevajalnik.py` najprej
# definirajte pomožno funkcijo `prevedi` in slovar `slovar` (oboje lahko
# skopirate iz naloge *Slovarji*), 
# nato pa glavni program dopolnite do delujočega:
# 
# 
#       def prevedi(): ... # TODO
# 
...
#               prevajalnik() 
#     
#       # V zadnji vrstici poženemo funkcijo prevajalnik, ki se bo klicala rekurzivno  
#       prevajalnik()
# =============================================================================
...
def prevajalnik():
      ...
      if niz == "Izhod":
          # Zaključimo izvajanje programa
          print("Prevajalnik se zapira. Čao.")
      else:
          # Prevedemo niz:
...
# =====================================================================@009837=
# 2. podnaloga
# Prevajalnik iz prejšnje točke lahko še izboljšamo tako, da omogočimo dodajanje
# besed slovarju. V datoteki `naprednejsi_prevajalnik.py` najprej definirajte pomožno
# funkcijo `prevedi` in slovar `slovar`, nato pa glavni program dopolnite do
# delujočega:
# 
# 
#       def prevedi(): ... # TODO
...
def naprednejsi_prevajalnik():
      # Najprej pridobimo ukaz: TODO
      ukaz = input("Kaj naj naredim (dodaj, prevedi ali izhod")
      # Ločimo primere glede na ukaz
      if ukaz == "Dodaj":
          # Pridobimo tujo besedo in njen prevod:
          ...
          # Pridobimo stavek:
          stavek = input("Vpiši stavek!")
          # Prevedemo stavek:
          prevod_stavla = ("Vpiši prevod stavka!")
          # Prevod izpišemo:
          print(prevod_stavka)
          # Rekurzivno poženemo program
          naprednejsi_prevajalnik() 
