...
def kalorije_na_dan(ime_datoteke):
    ...
    with open(ime_datoteke) as f:
        for vrstica in f:
            ...
            vsota_danes = sum(kalorije)
            rezultat.append(vsota_danes)
        return rezultat
# =====================================================================@001516=
# 3. podnaloga
...
def vsota_kalorij(ime_vhodne, ime_izhodne):
    seznam_kalorij = kalorije_na_dan(ime_vhodne)
    with open(ime_izhodne, "w") as f:
        for x in seznam_kalorij:
            print(x, file=f)
# =====================================================================@001517=
# 4. podnaloga
