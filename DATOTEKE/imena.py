...
def koliko_urejen(vhodna, izhodna):
    ...
    pari = []
    for ime in brez_ponovitev:
        pari.append((-vsa_imena.count(ime), ime)) #minus smo dodali, da obrnemo vrstni red funkcije sort

    #uredimo ta seznam parov od največje pojavitve proti najmanjši
    pari.sort()
