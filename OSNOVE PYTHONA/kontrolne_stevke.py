...
def dodaj_kontrolno_stevko(sklic):
    ...
    a6 = (sklic // 100000) % 10
    a7 = (sklic // 1000000) % 10
    a8 = (sklic // 10000000) % 10
    a9 = (sklic // 100000000) % 10
    a10 = (sklic // 1000000000) % 10
    a11 = (sklic // 10000000000) % 10
    a12 = (sklic // 100000000000) % 10
    b = a1*2 + a2*3 + a3*4 + a4*5 + a5*6 + a6*7 + a7*8 + a8*9 + a9*10 + a10*11 + a11*12 + a12*13
    k = 11 - (b % 11)
    if k < 10:
        return sklic * 10 + k
    else: 
...
def _validate_current_file():
    ...
    try:
        ...
        token = 'Token 109e20bea930878fd1d9516eecb90f62b7c44915'
